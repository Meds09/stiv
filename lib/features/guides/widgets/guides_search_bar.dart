...
class GuidesSearchBar extends ConsumerStatefulWidget {
  const GuidesSearchBar({super.key});

  @override
  ConsumerState<GuidesSearchBar> createState() => _GuidesSearchBarState();
}

class _GuidesSearchBarState extends ConsumerState<GuidesSearchBar> {
  @override
